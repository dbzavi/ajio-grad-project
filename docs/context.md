# AJIO Product Manager Task: Wishlist to Purchase Conversion
...
Think carefully about what needs to change for the business metric to improve. Use your metric decomposition alongside the output of your AI discovery engine to determine where the highest-potential opportunities lie.

## Part 3: Validate the Opportunity Through User Research
AI-generated insights are only a starting point. Choose a target user segment and opportunity area based on your initial analysis.
